...
public class NetSpawnedParticleGhostUpdateSystem : JobComponentSystem
{
    [BurstCompile]
...
#endif
        [ReadOnly] public ArchetypeChunkBufferType<NetSpawnedParticleSnapshotData> ghostSnapshotDataType;
...
#endif
                NetSpawnedParticleSnapshotData snapshotData;
...
#pragma warning restore 649
    ...
    protected override void OnCreate()
    {
        ...
        {
            All = new []{
                ComponentType.ReadWrite<NetSpawnedParticleSnapshotData>(),
        ...
        {
            All = new []{
                ComponentType.ReadOnly<NetSpawnedParticleSnapshotData>(),
                ComponentType.ReadOnly<GhostComponent>(),
        ...
        RequireForUpdate(GetEntityQuery(ComponentType.ReadWrite<NetSpawnedParticleSnapshotData>(),
            ComponentType.ReadOnly<GhostComponent>()));
    }
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
        if (!m_predictedQuery.IsEmptyIgnoreFilter)
        {
            var updatePredictedJob = new UpdatePredictedJob
            {
                ...
                ghostSnapshotDataType = GetArchetypeChunkBufferType<NetSpawnedParticleSnapshotData>(true),
...
public partial class NetSpawnedParticleGhostSpawnSystem : DefaultGhostSpawnSystem<NetSpawnedParticleSnapshotData>
{
}
