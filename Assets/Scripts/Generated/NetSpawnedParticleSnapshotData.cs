...
public struct NetSpawnedParticleSnapshotData : ISnapshotData<NetSpawnedParticleSnapshotData>
{
    public uint tick;
    ...
    public void PredictDelta(uint tick, ref NetSpawnedParticleSnapshotData baseline1, ref NetSpawnedParticleSnapshotData baseline2)
    {
    ...
    public void Serialize(int networkId, ref NetSpawnedParticleSnapshotData baseline, DataStreamWriter writer, NetworkCompressionModel compressionModel)
    {
    ...
    public void Deserialize(uint tick, ref NetSpawnedParticleSnapshotData baseline, DataStreamReader reader, ref DataStreamReader.Context ctx,
    ...
    public void Interpolate(ref NetSpawnedParticleSnapshotData target, float factor)
    {
